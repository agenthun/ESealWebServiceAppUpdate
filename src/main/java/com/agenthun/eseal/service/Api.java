...
public class Api {
    ...
    public static final String UPDATE_APP_TYPE_ESEAL = "2";
    public static final String UPDATE_APP_TYPE_ESEAL_LITE = "3";
    public static final String UPDATE_APP_TYPE_CHASER = "4";
}
